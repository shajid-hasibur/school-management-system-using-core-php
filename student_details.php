                            ...
                            <div class="col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-body text-center" style="background-color: #d1f4ff">
                                        ...
                                        <strong><p class="text-muted mb-1">Student ID : <?php echo $row['id_no']; ?></p></strong>
                                        <strong><p class="text-muted mb-1">Class : <?php echo $row['class']['name']; ?></p></strong>
                                        <strong><p class="text-muted mb-1">Year : <?php echo $row['year']['name']; ?></p></strong>
                                        <strong><p class="text-muted mb-1">Section : <?php echo $row['section']['name']; ?></p></strong>
                                        <strong><p class="text-muted mb-1">Group : <?php echo $row['group']['name']; ?></p></strong>
                                        <strong><p class="text-muted mb-1">Discount : <?php echo $row['discount'].'%'; ?></p></strong>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body mt-3 mb-3 d-flex justify-content-center align-items-center">
                                        <a href="" class="btn btn-primary" style="width: 140px;"><i class="fas fa-graduation-cap"></i>Promotion</a>
                                        <a href="" class="btn btn-danger" style="width: 140px; margin-left: 10px;"><i class="fas fa-trash"></i>Delete Record</a>
                                    </div>
                                </div>
                            </div>
                        </div>
