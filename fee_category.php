  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="deleteFeeBtn" class="btn btn-primary">Yes, Delete!</button>
      </div>
    </div>
  </div>
</div>
	    									...
	    									foreach ($query_run as $key => $value) {
	    										?>
	    											<tr>
	    												...
	    												<td>
	    													<a  href="edit_fee_category.php?fee_category_id=<?php echo $value['id']?>" type="button" class="btn btn-info btn-sm"><i class="fas fa-edit"></i>Edit</a>
