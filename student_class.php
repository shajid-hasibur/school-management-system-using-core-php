  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="deleteClassBtn" class="btn btn-primary">Yes, Delete!</button>
      </div>
    </div>
  </div>
</div>
	    									...
	    									foreach ($query_run as $key => $value) {
	    										?>
	    											<tr>
	    												...
	    												<td>
	    													<a  href="edit_class_page.php?class_id=<?php echo $value['id']?>" type="button" class="btn btn-info btn-sm"><i class="fas fa-edit"></i>&nbsp;Edit</a>
